...
def main():
    ...
    col1, col2 = st.columns([4, 5])  # Specify the number of columns as an integer (3).
    with col1:
    ...
    with col2:
        with elements("properties"):
            ...
            # </Paper>
            #add a mui div
            with html.div(label = "flex-container", css = {"display" : "flex", "flex-direction" : "row", "background-color" : "grey", "width" : "800px"}):
                with html.div(label="headshot", css = {"display" : "flex", "justify-content" : "center", "align-items": "center"}):
                    html.img(src="https://placekitten.com/200/300", css = {"width" : "100%", "height" : "100%"})
                with html.div(label="stuff"):
                    html.h2("Hii", css = {"padding-left" : "10px", "width" :"100%"});
                with html.div(label="seller_food", css={"margin-left" : "auto"}):
